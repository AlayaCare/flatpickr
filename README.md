...
NOTE: The release is tagged to `4.6.4`. This tag is branched out from `4.6.3` and I added my fix. There is a bug somewhere from tag `4.6.3` and master as of 2020-05-13 that causes issue with the date-time calendar and the now button we implemented.
